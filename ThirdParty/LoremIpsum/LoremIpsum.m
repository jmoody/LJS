...
- (NSString*) randomWord {
  return [LjsVariates randomElement:self.loremIpsumWords];
}
...
- (NSString*) words:(NSUInteger) count {
  if (count==0) return @"";
  NSArray *sampled = [LjsVariates sampleWithReplacement:self.loremIpsumWords number:count];
  return [sampled componentsJoinedByString:@" "];
}
