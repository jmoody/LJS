...
+ (void)queueLogMessage:(DDLogMessage *)logMessage asynchronously:(BOOL)asyncFlag
{
    ...
    [logMessage retain];  // released in lt_log.  Various forms of multi-threading are optionally performed, so this ugly retain is needed.
...
+ (void)lt_log:(DDLogMessage *)logMessage
{
    ...
    [logMessage release]; // was retained in queueLogMessage:synchronously:
}
